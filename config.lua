  ...
  ['LSPD Silah Marketi'] = {
    ...
    ['Teknoloji Marketi'] = {
        ...
        items = {
            ...
            [2] = { name = "drone3", price = 100, count = 100,  info = {},  type = "item", slot = 2, },
            [3] = { name = "drone4", price = 100, count = 100,  info = {},  type = "item", slot = 3, },
        },
        markerType = 2,
        markerSize = vector3(0.2, 0.2, 0.2),
        markerColour = { r = 255, g = 255, b = 255 },
    ...
    ['Market'] = {
        ...
        items = {
            [1] = { name = "hamburger", price = 100, count = 100,  info = {},  type = "item", slot = 1, },
            [2] = { name = "donut", price = 150, count = 100,  info = {},  type = "item", slot = 2, },
            [3] = { name = "chocolate", price = 250, count = 100,  info = {},  type = "item", slot = 3, },
            [4] = { name = "hotdog", price = 60, count = 100,  info = {},  type = "item", slot = 4, },
            [5] = { name = "sandvich", price = 160, count = 100,  info = {},  type = "item", slot = 5, },
            [6] = { name = "water", price = 10, count = 100,  info = {},  type = "item", slot = 6, },
            [7] = { name = "cola", price = 50, count = 100,  info = {},  type = "item", slot = 7, },
            [8] = { name = "kahve", price = 40, count = 100,  info = {},  type = "item", slot = 8, },
            [9] = { name = "icetea", price = 70, count = 100,  info = {},  type = "item", slot = 9, },
            [10] = { name = "energy", price = 10, count = 100,  info = {},  type = "item", slot = 10, },   
        },
        markerType = 2,
        markerSize = vector3(0.2, 0.2, 0.2),
        markerColour = { r = 255, g = 255, b = 255 },
